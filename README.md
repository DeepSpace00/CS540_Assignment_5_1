...
6. Create a table and import the dataset `flights-export.csv` into testsqlite.db using sqlite-web.
    ...
    ![](screenshots/step_6a.png)

    ![](screenshots/step_6b.png)
